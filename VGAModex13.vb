...
Public Class VGAMode0x13Class
   Private Const VIDEO_ADDRESS As Integer = &HA0000%   'Defines the video memory's base address.
   Public ReadOnly SCREEN_SIZE As Size = New Size(320, 200)   'Contains the screen size measured in pixels.
   ...
   Public Sub Display(Screen As Image, Memory() As Byte)
      For y As Integer = 0 To SCREEN_SIZE.Height - 1
         For x As Integer = 0 To SCREEN_SIZE.Width - 1
            With DirectCast(Screen, Bitmap)
               .SetPixel(x, y, Color.FromArgb(DEFAULT_PALETTE(Memory(VIDEO_ADDRESS + ((y * SCREEN_SIZE.Width) + x))) Or &HFF000000%))
            End With
         Next x
      Next y
   End Sub
