...
Public Class ScreenWindow
   ...
   Private KeyASCII As New Integer?                                     'Contains the ASCII code for the most recently pressed character key.
   ...
   Private Sub ScreenWindow_KeyUp(sender As Object, e As KeyEventArgs) Handles MyBase.KeyUp
      Try
         Dim BIOSKeyCode As Integer? = GetBIOSKeyCode(e, KeyASCII)
   ...
   Private Sub ScreenWindow_KeyPress(sender As Object, e As KeyPressEventArgs) Handles MyBase.KeyPress
      Try
         If e.KeyChar >= " "c Then KeyASCII = ToInt32(Char.ToUpper(e.KeyChar))
      Catch ExceptionO As Exception
         DisplayException(ExceptionO.Message)
      End Try
   End Sub
