...
'This class emulates low resolution VGA.
Public Class LowResolutionVGA
   Implements VideoAdapterClass

   Private Const VIDEO_ADDRESS As Integer = &HA0000%   'Defines the video memory's base address.
      ...
      For y As Integer = 0 To ScreenSize.Height - 1
         For x As Integer = 0 To ScreenSize.Width - 1
            With DirectCast(Screen, Bitmap)
               .SetPixel(x, y, Color.FromArgb(DEFAULT_PALETTE(Memory(VIDEO_ADDRESS + ((y * ScreenSize.Width) + x))) Or &HFF000000%))
            End With
         Next x
      Next y
   End Sub
