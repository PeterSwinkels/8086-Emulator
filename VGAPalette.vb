...
'This class contains the VGA palette related procedures.
Public Class VGAPaletteClass
   ...
   Public Sub WriteToDAC(Value As Integer)
      ...
      If Values.Count = &H3% Then
         ...
         VGA_PALETTE.VGAPaintBrushes(SelectedAddress) = New SolidBrush(Color.FromArgb(VGA_DEFAULT_PALETTE(SelectedAddress) Or &HFF000000%))
         Values.Clear()
      End If
   End Sub
End Class
